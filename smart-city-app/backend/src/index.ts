...
class GeospatialService {
  ...
  getHistoricalPlaceDescription(name: string, tags: any): string {
    ...
    const descriptions: { [key: string]: string } = {
      ...
      'margaret island': 'Margaret Island - Recreational island in the Danube, popular park and spa destination.',
      ...
      'gellért hill': 'Gellért Hill - Historic hill with citadel, Liberty Statue, and panoramic views.',
      'castle hill': 'Castle Hill - Historic hill with Buda Castle, museums, and medieval streets.',
      ...
      'ráckeve': 'Ráckeve - Town south of Budapest, on Csepel Island.',
